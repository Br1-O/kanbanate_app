...
export const BoardList = async() => {
    ...
    //fetch currently active organization's boards
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 text-neutral-900">
            {boards.map((board) => (
                <Link 
                    key={board.id}
                    href={`/board/${board.id}`}
